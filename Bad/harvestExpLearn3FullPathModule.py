...
def run_harvest():
    print("harvest Start running Python calculation script")
    print("\nharvest run_harvest() sys.argv: ", sys.argv, "\n")
    global targetFile
    global trainingSets
    MyPath = ''
...
##### Definitions #####
    ...
    ##### Start calculation ###################################################
    ##### Argument handling ###############
    print("harvest 187 - Start Argument handling")
    print("\n harvest188 - sys.argv: ", sys.argv, "\n")
    ...
    print("\n harvest 208 args: ", args, "\n")
#    print("harvest 209 - trainingSets: ", trainingSets)
#    print("harvest 210 - targetFile: ", targetFile)
    print("harvest 211 - args.targetFile: ", args.targetFile)
    print("harvest 212 - args.trainingSets: ", args.trainingSets)
    trainingSets = args.trainingSets[0]
    targetFile = args.targetFile[0]
    print("harvest 215 - targetFile: ", targetFile)
    print("harvest 216 - trainingSets: ", trainingSets)
    print("harvest 217 - targetFile: ", targetFile)
    print("harvest 218 - trainingSets[0]: ", trainingSets[0])
    ...
    print('harvest targetFile: ', targetFile)
    ...
    print("harvest 257 - trainingSets: ", trainingSets)
    print("harvest 258 - targetFile: ", targetFile)

    #DAW
    trainingSets = args.trainingSets
    #trainingSets = ['Clothes.csv', 'Eyes.csv', 'Stuffing.csv']
    print('harvest trainingSets: ', trainingSets)
    #DAW    labels = []
...
#    targetFile = targetFile
    if targetFile:
        if (".csv") not in targetFile:
            print ("Target file, %s, must be a csv file" % (targetFile))
            sys.exit(0)
    ...
    #DAW - replace args.targetFile with targetFile
    targetFile = args.targetFile
    #Global replace targetFile with targetFile - DAWwho did this?
    if targetFile:
        print ("harvest Classifying %s" % (targetFile))
    ...
    #    print args.targetFile
        ...
        with open (resultFile, 'w') as result_FH:
            ...
            with open (targetFile, 'rU') as target_FH:
                resultData = csv.writer(result_FH)
                with open (MyPath+targetFile, 'rU') as target_FH:
                    specFields=[]
                    ipcFields=[]
                    cpcFields=[]
                    upcFields=[]
